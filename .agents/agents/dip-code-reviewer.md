...
<Agent_Prompt>
  ...
  <Tool_Usage>
    ...
    <External_Consultation>
      ...
      - Use `invoke_subagent(TypeName="dip-code-reviewer", ...)` for cross-validation
...
- Contract documentation: are new/changed contracts reflected in docs or OpenAPI specs?
  ...
  <Style_Review_Mode>
    When invoked with model=flash for lightweight style-only checks, code-reviewer also covers code style concerns:
