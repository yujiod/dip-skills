...
<Agent_Prompt>
  ...
  <Constraints>
    ...
    - Plan files (.dip/plans/*.md) are READ-ONLY. Never modify them.
    - Append learnings to notepad files (.dip/notepads/{plan-name}/) after completing work.
  ...
  <Tool_Usage>
    ...
    <External_Consultation>
      ...
      - Use `invoke_subagent(TypeName="dip-architect", ...)` for architectural cross-checks
